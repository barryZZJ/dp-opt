...
from dpopt.probability.estimators_origin import PrEstOrigin, EpsEstOrigin
...
class DPSniper:
    ...
    def __init__(self, mechanism: Mechanism, classifier_factory: ClassifierFactory, config: DPConfig):
        """
        Create an optimizer.
        ...
        self.config = config
        self.pr_estimator = PrEstOrigin(mechanism, self.config.n, self.config)
        self.eps_estimator = EpsEstOrigin(self.pr_estimator)

    def best_attack(self, a1, a2) -> MlAttackOrigin:
        """
